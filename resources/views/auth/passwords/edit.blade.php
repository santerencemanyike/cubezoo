        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.updateProfile") }}" enctype="multipart/form-data">
                    ...
                    @if(auth()->user()->image)
                        <div class="m-1">
                            <img src="{{ asset('storage/' . auth()->user()->image) }}" alt="Profile Image" style="width: 80px; height: 80px; object-fit: cover; border-radius: 50%;">
                        </div>
                    @else
                        <div class="m-1">
                            <img src="{{ asset('images/resume-profile.png') }}" alt="Profile Image" style="width: 60px; height: 60px; object-fit: cover;">
                        </div>
                    @endif
                    ...
                    <div class="form-group">
                        <button class="btn btn-stm" type="submit">
                            {{ trans('global.save') }}
                        </button>
                    </div>
                </form>
